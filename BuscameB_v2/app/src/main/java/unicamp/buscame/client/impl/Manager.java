 ...
 */
class Manager implements IManager, unicamp.buscame.client.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IClientManagerProv, new IClientManagerFacade(this));
        this.setProvidedInterfaceTypes(IClientManagerProv, IClientManager.class);
