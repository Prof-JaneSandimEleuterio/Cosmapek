...
import unicamp.buscame.conn_company_controller.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_company_controller.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ICompanyManagerTag, new unicamp.buscame.conn_company_controller.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ICompanyManagerTag,  unicamp.buscame.controller.req.ICompanyManager.class);
