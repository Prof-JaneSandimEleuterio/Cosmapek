...
import unicamp.buscame.conn_configurationB_configurationBSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConfigurationManagerTag, new unicamp.buscame.conn_configurationB_configurationBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IConfigurationManagerTag, unicamp.buscame.configurationBSensor.req.IConfigurationManager.class);

        //required
        this.setRequiredInterfaceTypes(IConfigurationManagerTag, unicamp.buscame.configurationB.prov.IConfigurationManager.class);
    }
