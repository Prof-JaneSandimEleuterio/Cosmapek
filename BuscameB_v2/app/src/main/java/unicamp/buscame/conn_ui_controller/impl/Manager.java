...
import unicamp.buscame.conn_ui_controller.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_ui_controller.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IUiManagerTag, new unicamp.buscame.conn_ui_controller.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IUiManagerTag, unicamp.buscame.controller.req.IUiManager.class);

        //required
        this.setRequiredInterfaceTypes(IUiManagerTag, unicamp.buscame.ui.prov.IUiManager.class);
    }
