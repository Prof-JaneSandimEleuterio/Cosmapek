...
public interface IInterfaceTags {
    ...
    static final String IConfigurationManagerTag = "IConfigurationManager";
    static final String ILocalizationManagerTag = "ILocalizationManager";
    static final String IClientManagerTag = "IClientManager";
    static final String ICompanyManagerTag = "ICompanyManager";
    static final String IUiManagerTag = "IUiManager";
    //static final String IControllerManagerTag = "IControllerManager";
