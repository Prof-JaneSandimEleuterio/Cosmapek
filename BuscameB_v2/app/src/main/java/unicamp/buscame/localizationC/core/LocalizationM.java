...
public class LocalizationM {
    ...
    public CompanyList getCompanyList(Double longitude, Double latitude, int numCompanies) {
        getManagers();
...
//        ClientResource cr = new ClientResource("http://192.168.0.104:5228/v1/companies");
        ClientResource cr = new ClientResource("http://177.220.84.151:5228/v1/companies");
