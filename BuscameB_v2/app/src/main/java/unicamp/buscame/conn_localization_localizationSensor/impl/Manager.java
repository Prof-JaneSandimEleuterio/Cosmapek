...
import unicamp.buscame.conn_localization_localizationSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILocalizationManagerTag, new unicamp.buscame.conn_localization_localizationSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localizationSensor.req.ILocalizationManager.class);
