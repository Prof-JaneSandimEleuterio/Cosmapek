...
import unicamp.buscame.conn_client_ui.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_client_ui.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IClientManagerTag, new unicamp.buscame.conn_client_ui.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IClientManagerTag, unicamp.buscame.ui.req.IClientManager.class);

        //required
        this.setRequiredInterfaceTypes(IClientManagerTag, unicamp.buscame.client.prov.IClientManager.class);
    }
