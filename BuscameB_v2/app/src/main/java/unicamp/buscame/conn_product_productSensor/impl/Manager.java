...
import unicamp.buscame.conn_product_productSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerTag, new unicamp.buscame.conn_product_productSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IProductManagerTag, unicamp.buscame.productSensor.req.IProductManager.class);
