...
import unicamp.buscame.conn_localization_company.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_localization_company.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILocalizationManagerTag, new unicamp.buscame.conn_localization_company.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.company.req.ILocalizationManager.class);

        //required
        this.setRequiredInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localization.prov.ILocalizationManager.class);
    }
