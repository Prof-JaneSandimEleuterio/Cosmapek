 ...
 */
class Manager implements IManager, unicamp.buscame.company.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ICompanyManagerProv, new ICompanyManagerFacade(this));
        this.setProvidedInterfaceTypes(ICompanyManagerProv, ICompanyManager.class);

        //required
        this.setRequiredInterfaceTypes(IConfigurationManagerReq, IConfigurationManager.class);
        this.setRequiredInterfaceTypes(ILocalizationManagerReq, ILocalizationManager.class);
        this.setRequiredInterfaceTypes(IProductManagerReq, IProductManager.class);
    }
