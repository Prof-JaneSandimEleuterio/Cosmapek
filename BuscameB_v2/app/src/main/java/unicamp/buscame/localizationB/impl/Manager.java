...
import unicamp.buscame.localizationB.impl.ILocalizationManagerFacade;
 ...
 */
class Manager implements IManager, unicamp.buscame.localizationB.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILocalizationManagerProv, new ILocalizationManagerFacade(this));
        this.setProvidedInterfaceTypes(ILocalizationManagerProv, ILocalizationManager.class);
