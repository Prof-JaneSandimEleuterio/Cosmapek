...
import unicamp.buscame.conn_productB_productBSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerTag, new unicamp.buscame.conn_productB_productBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IProductManagerTag, unicamp.buscame.productBSensor.req.IProductManager.class);

        //required
        this.setRequiredInterfaceTypes(IProductManagerTag, unicamp.buscame.productB.prov.IProductManager.class);
    }
