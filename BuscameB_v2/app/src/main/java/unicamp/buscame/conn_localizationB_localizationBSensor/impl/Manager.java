...
import unicamp.buscame.conn_localizationB_localizationBSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILocalizationManagerTag, new unicamp.buscame.conn_localizationB_localizationBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localizationBSensor.req.ILocalizationManager.class);

        //required
        this.setRequiredInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localizationB.prov.ILocalizationManager.class);
    }
