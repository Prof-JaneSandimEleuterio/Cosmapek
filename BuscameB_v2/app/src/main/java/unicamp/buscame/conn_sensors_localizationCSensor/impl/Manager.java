...
import unicamp.buscame.conn_sensors_localizationCSensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new unicamp.buscame.conn_sensors_localizationCSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, unicamp.buscame.localizationCSensor.req.ISensorUpdater.class);
