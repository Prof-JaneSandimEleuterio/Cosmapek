...
import unicamp.buscame.conn_sensors_configurationSensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new unicamp.buscame.conn_sensors_configurationSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, unicamp.buscame.configurationSensor.req.ISensorUpdater.class);
