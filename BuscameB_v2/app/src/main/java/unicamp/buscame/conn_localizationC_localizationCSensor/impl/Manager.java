...
import unicamp.buscame.conn_localizationC_localizationCSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ILocalizationManagerTag, new unicamp.buscame.conn_localizationC_localizationCSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localizationCSensor.req.ILocalizationManager.class);

        //required
        this.setRequiredInterfaceTypes(ILocalizationManagerTag, unicamp.buscame.localizationC.prov.ILocalizationManager.class);
    }
