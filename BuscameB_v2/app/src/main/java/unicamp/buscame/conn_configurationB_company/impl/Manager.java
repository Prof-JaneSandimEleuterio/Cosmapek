...
import unicamp.buscame.conn_configurationB_company.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConfigurationManagerTag, new unicamp.buscame.conn_configurationB_company.impl.Adapter(this));
