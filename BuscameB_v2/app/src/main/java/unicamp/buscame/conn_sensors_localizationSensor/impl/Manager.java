...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new unicamp.buscame.conn_sensors_localizationSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, unicamp.buscame.localizationSensor.req.ISensorUpdater.class);
