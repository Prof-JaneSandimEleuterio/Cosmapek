...
import unicamp.buscame.conn_configuration_company.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_configuration_company.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConfigurationManagerTag, new unicamp.buscame.conn_configuration_company.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IConfigurationManagerTag, unicamp.buscame.company.req.IConfigurationManager.class);

        //required
        this.setRequiredInterfaceTypes(IConfigurationManagerTag, unicamp.buscame.configuration.prov.IConfigurationManager.class);
    }
