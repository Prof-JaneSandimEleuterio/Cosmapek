...
import unicamp.buscame.conn_productC_productCSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerTag, new unicamp.buscame.conn_productC_productCSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IProductManagerTag, unicamp.buscame.productCSensor.req.IProductManager.class);

        //required
        this.setRequiredInterfaceTypes(IProductManagerTag, unicamp.buscame.productC.prov.IProductManager.class);
    }
