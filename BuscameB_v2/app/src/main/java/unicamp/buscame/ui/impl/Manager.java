 ...
 */
class Manager implements IManager, unicamp.buscame.ui.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IUiManagerProv, new IUiManagerFacade(this));
        this.setProvidedInterfaceTypes(IUiManagerProv, IUiManager.class);

        //required
        this.setRequiredInterfaceTypes(ICompanyManagerReq, ICompanyManager.class);
        this.setRequiredInterfaceTypes(IClientManagerReq, IClientManager.class);
    }
