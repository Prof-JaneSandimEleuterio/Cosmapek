...
import unicamp.buscame.configurationB.impl.IConfigurationManagerFacade;
 ...
 */
class Manager implements IManager, unicamp.buscame.configurationB.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConfigurationManagerProv, new IConfigurationManagerFacade(this));
        this.setProvidedInterfaceTypes(IConfigurationManagerProv, IConfigurationManager.class);
