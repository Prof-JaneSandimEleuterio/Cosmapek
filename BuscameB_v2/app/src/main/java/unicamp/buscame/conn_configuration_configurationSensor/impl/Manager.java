...
import unicamp.buscame.conn_configuration_configurationSensor.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IConfigurationManagerTag, new unicamp.buscame.conn_configuration_configurationSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IConfigurationManagerTag, unicamp.buscame.configurationSensor.req.IConfigurationManager.class);
