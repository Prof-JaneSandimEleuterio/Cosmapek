...
public class ProductM {
    ...
    public synchronized CompanyProductList getCompanyProductList(String companyId) {
        ...
        //ClientResource cr = new ClientResource("http://192.168.0.104:10000/v1/companies/"+companyId+"/products/");
        ClientResource cr = new ClientResource("http://177.220.84.151:10000/v1/companies/"+companyId+"/products/");
