...
import unicamp.buscame.productB.impl.IProductManagerFacade;
 ...
 */
class Manager implements IManager, unicamp.buscame.productB.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerProv, new IProductManagerFacade(this));
        this.setProvidedInterfaceTypes(IProductManagerProv, IProductManager.class);
