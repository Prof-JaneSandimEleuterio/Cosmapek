...
import unicamp.buscame.localizationCSensor.impl.ISensorUpdaterManagerFacade;
 ...
 */
class Manager implements IManager, unicamp.buscame.localizationCSensor.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        //required
        // this.setRequiredInterfaceTypes(ISensorManagerReq, IConfigurationManager.class);
