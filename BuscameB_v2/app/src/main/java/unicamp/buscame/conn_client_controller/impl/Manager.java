 ...
 */
class Manager implements IManager, unicamp.buscame.conn_client_controller.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IClientManagerTag, new unicamp.buscame.conn_client_controller.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IClientManagerTag, unicamp.buscame.controller.req.IClientManager.class);
