...
import unicamp.buscame.conn_productC_company.impl.*;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerTag, new unicamp.buscame.conn_productC_company.impl.Adapter(this));
