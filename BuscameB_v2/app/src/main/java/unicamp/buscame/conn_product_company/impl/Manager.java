...
import unicamp.buscame.conn_product_company.impl.*;
 ...
 */
class Manager implements IManager, unicamp.buscame.conn_product_company.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(IProductManagerTag, new unicamp.buscame.conn_product_company.impl.Adapter(this));
        this.setProvidedInterfaceTypes(IProductManagerTag, unicamp.buscame.company.req.IProductManager.class);

        //required
        this.setRequiredInterfaceTypes(IProductManagerTag, unicamp.buscame.product.prov.IProductManager.class);
    }
