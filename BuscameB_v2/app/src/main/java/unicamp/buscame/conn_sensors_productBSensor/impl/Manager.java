...
import unicamp.buscame.conn_sensors_productBSensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new unicamp.buscame.conn_sensors_productBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, unicamp.buscame.productBSensor.req.ISensorUpdater.class);
