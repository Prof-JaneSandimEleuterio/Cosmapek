...
import unicamp.buscame.conn_sensors_localizationBSensor.impl.IInterfaceTags;
...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterface(ISensorUpdaterTag, new unicamp.buscame.conn_sensors_localizationBSensor.impl.Adapter(this));
        this.setProvidedInterfaceTypes(ISensorUpdaterTag, unicamp.buscame.localizationBSensor.req.ISensorUpdater.class);
