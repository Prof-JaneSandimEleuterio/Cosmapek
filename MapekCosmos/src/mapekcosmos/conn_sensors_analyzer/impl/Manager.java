 ...
 */
class Manager implements IManager, mapekcosmos.conn_sensors_analyzer.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(ISensorManagerTag, mapekcosmos.analyzer.req.ISensorManager.class);
