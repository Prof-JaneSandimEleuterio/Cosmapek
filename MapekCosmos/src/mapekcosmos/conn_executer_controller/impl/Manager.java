 ...
 */
class Manager implements IManager, mapekcosmos.conn_executer_controller.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IExecutionManagerTag,
            mapekcosmos.controller.req.IExecutionManager.class);

        //required
        this.setRequiredInterfaceTypes(IExecutionManagerTag, mapekcosmos.executer.prov.IExecutionManager.class);
    }
