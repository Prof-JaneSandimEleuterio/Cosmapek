 ...
 */
class Manager implements IManager, mapekcosmos.conn_connectors_planner.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IConnectorManagerTag, mapekcosmos.planner.req.IConnectorManager.class);

        //required
        this.setRequiredInterfaceTypes(IConnectorManagerTag,
            mapekcosmos.connectors.prov.IConnectorManager.class);
    }
