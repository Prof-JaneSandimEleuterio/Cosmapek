 ...
 */
class Manager implements IManager, mapekcosmos.conn_components_reader.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IComponentManagerTag, mapekcosmos.reader.req.IComponentManager.class);
