 ...
 */
class Manager implements IManager, mapekcosmos.conn_features_reader.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IFeatureManagerTag, mapekcosmos.reader.req.IFeatureManager.class);
