 ...
 */
class Manager implements IManager, mapekcosmos.conn_connectors_reader.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IConnectorManagerTag, mapekcosmos.reader.req.IConnectorManager.class);
