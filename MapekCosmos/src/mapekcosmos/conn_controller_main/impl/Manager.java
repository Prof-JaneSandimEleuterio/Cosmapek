...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IControllerManagerTag, mapekcosmos.main.req.IControllerManager.class);

        //required
        this.setRequiredInterfaceTypes(IControllerManagerTag,
            mapekcosmos.controller.prov.IControllerManager.class);
    }
