 ...
 */
class Manager implements IManager, mapekcosmos.conn_analyzer_planner.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IAnalysisManagerTag, mapekcosmos.planner.req.IAnalysisManager.class);
