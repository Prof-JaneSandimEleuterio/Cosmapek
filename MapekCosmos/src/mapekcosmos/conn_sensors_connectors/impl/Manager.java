 ...
 */
class Manager implements IManager, mapekcosmos.conn_sensors_connectors.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(ISensorManagerTag, mapekcosmos.connectors.req.ISensorManager.class);
