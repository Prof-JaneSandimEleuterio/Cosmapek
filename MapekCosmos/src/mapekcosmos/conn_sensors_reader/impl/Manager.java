 ...
 */
class Manager implements IManager, mapekcosmos.conn_sensors_reader.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(ISensorManagerTag, mapekcosmos.reader.req.ISensorManager.class);
