 ...
 */
class Manager implements IManager, mapekcosmos.conn_planner_controller.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IPlanningManagerTag, mapekcosmos.controller.req.IPlanningManager.class);

        //required
        this.setRequiredInterfaceTypes(IPlanningManagerTag, mapekcosmos.planner.prov.IPlanningManager.class);
    }
