 ...
 */
class Manager implements IManager, mapekcosmos.conn_planner_executer.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IPlanningManagerTag, mapekcosmos.executer.req.IPlanningManager.class);
