 ...
 */
class Manager implements IManager, mapekcosmos.conn_sensors_planner.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(ISensorManagerTag, mapekcosmos.planner.req.ISensorManager.class);
