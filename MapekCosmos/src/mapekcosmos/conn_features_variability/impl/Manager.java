 ...
 */
class Manager implements IManager, mapekcosmos.conn_features_variability.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IFeatureManagerTag, mapekcosmos.variability.req.IFeatureManager.class);

        //required
        this.setRequiredInterfaceTypes(IFeatureManagerTag, mapekcosmos.features.prov.IFeatureManager.class);
    }
