 ...
 */
class Manager implements IManager, mapekcosmos.conn_components_planner.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IComponentManagerTag, mapekcosmos.planner.req.IComponentManager.class);

        //required
        this.setRequiredInterfaceTypes(IComponentManagerTag,
            mapekcosmos.components.prov.IComponentManager.class);
    }
