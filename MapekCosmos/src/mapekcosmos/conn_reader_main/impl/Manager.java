...
class Manager implements IManager, IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(IReadingManagerTag, mapekcosmos.main.req.IReadingManager.class);

        //required
        this.setRequiredInterfaceTypes(IReadingManagerTag, mapekcosmos.reader.prov.IReadingManager.class);
    }
