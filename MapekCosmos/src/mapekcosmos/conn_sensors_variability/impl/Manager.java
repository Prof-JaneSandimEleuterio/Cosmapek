 ...
 */
class Manager implements IManager, mapekcosmos.conn_sensors_variability.impl.IInterfaceTags {
    ...
    Manager() {
        ...
        this.setProvidedInterfaceTypes(ISensorManagerTag, mapekcosmos.variability.req.ISensorManager.class);

        //required
        this.setRequiredInterfaceTypes(ISensorManagerTag, mapekcosmos.sensors.prov.ISensorManager.class);
    }
