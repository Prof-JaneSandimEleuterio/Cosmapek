 ...
 */
public class PlannerTest implements IInterfaceTags {
    ...
    @org.junit.Test public void getComponents() {
        //   plannIPlann.start();
        //   plannIPlann.getComponents();
        ...
        plannIPlann.start();
        LinkedList<String> com=plannIPlann.getComponents();
