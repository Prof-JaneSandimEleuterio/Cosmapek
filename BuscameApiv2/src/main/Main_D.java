...
public class Main_D {
    ...
    public static void main(String[] args) {
        ...
        //public static String remoteServer="remote:localhost/ApiBuscame_D"; in DBConfiguration
        try {
            OServerAdmin serverAdmin = new OServerAdmin("remote:localhost");
            serverAdmin.connect("root", "cupecupe");
            //object
            serverAdmin.createDatabase("ApiBuscame_D", "document", "plocal");
            serverAdmin.close();

            // create initial Data
            FillDataBase_D abc=new FillDataBase_D();
            abc.insertSetElements();
            Component c = new Component();
            c.getServers().add(Protocol.HTTP, 9418);
