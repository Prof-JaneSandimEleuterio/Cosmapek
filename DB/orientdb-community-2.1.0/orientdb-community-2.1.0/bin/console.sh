...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.1.0.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
"$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2015-08-05 13:38:23+0000" -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.1.0.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" com.orientechnologies.orient.graph.console.OGremlinConsole $*
